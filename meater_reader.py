...
def main():
    ...
    for reading in readings_list:
        print(reading)
    print(f"Sum of valid meters: {sum_of_valid_meters(readings_list)}")
    print(f"Sum of invalid meters: {sum_of_invalid_meters(readings_list)}")
    print(f"h and L: {find_highest_and_lowest_valid_reading(readings_list)}")
    print(f"R and O: {find_most_recent_and_oldest_reading(readings_list)}")
...
def find_highest_and_lowest_valid_reading(readings_list):
    valid_readings = [reading['VALUE'] for reading in readings_list if reading['STATUS'] == 'V']
...
def find_most_recent_and_oldest_reading(readings_list):
    valid_dates = [reading['DATE'] for reading in readings_list]
